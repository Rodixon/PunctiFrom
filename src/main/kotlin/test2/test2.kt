...
fun setupClickListeners1(clickProcessor: ClickProcessor) {

    val clickListener = object : ClickListener {
        override fun onClick(elementId: String): String {
            return "${elementId} clicked!"
        }
    }

    clickProcessor.registerClickListener("Button 1", clickListener)
    clickProcessor.registerClickListener("Button 2", clickListener)
    clickProcessor.registerClickListener("Button 3", clickListener)
}
